...
#from . import LabelSmoothedCrossEntropyCriterion
#from fairseq.criterions import LabelSmoothedCrossEntropyCriterion


@register_criterion('label_smoothed_cross_entropy_with_langid')
class LabelSmoothedCrossEntropyCriterionWithLangID(LabelSmoothedCrossEntropyCriterion):
